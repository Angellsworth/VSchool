...
//     - If inner function returns `true` (or something "truthy"), that item is included in
//      the new array. If it returns `false` (or something "falsey"), it doesn't include it 
//      in the new array.
